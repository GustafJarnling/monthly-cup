          ...
          <div className="call-of-action-component-2">
            <div className="call-of-action-component-3">
              <div className="call-of-action-component-4">
                <h2>Together we have saved the earth 2013161 pads and tampoons</h2>
              </div>
              <div className="call-of-action-component-5 w-hidden-medium w-hidden-small w-hidden-tiny"></div>
            </div>
            <div className="call-of-action-component-3">
              <div className="call-of-action-component-4">
                <div className="p-big">A woman uses an average of about 12,000 tampons and pads in her lifetime, or about FOUR menstrual cups. <br/>That makes a huge difference to the mountains of waste!</div>
              </div>
