        ...
        <div className="hero-section-component-2">
          <div className="hero-section-component-3">
            <div className="hero-section-component-4">
              <h1>Want smart and reliable menstrual protection?</h1>
              <div className="hero-section-component-5">
                <div>MenstrualCup is a reusable vessel that fits inside the vaginal walls and collects menstrual flow without leaking.</div>
              </div>
            </div>
                  ...
                  <div className="box-5-component-2">
                    <div className="box-5-component-3">
                      <a href="#" className="button-1 button-expand button-outlined w-button">
                        Buy your menstrual Cup <span className="w-hidden-tiny">(€21,99)</span>
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="box-5-component-2">
                    <div className="box-5-component-3">
                      <a href="#" className="button-1 button-expand w-button">
                        Get a new cup every 2yrs <span className="w-hidden-tiny">(€2,99/Mo)</span>
                      </a>
                    </div>
                  </div>
                </div>
          ...
          <div className="hero-section-component-8">
            <img src="images/Group-63x.jpg" srcSet="images/Group-63x-p-800.jpeg 800w, images/Group-63x-p-1080.jpeg 1080w, images/Group-63x-p-1600.jpeg 1600w, images/Group-63x.jpg 1791w" sizes="(max-width: 479px) 100vw, (max-width: 991px) 282.046875px, 46vw" className="hero-section-component-9"/>
          </div>
        </div>
      </div>
    </div>
